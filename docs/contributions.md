...
| 2026-04-03 | Chat | Alpha-ratio fix: `_alpha_ratio()` patched to skip first 10% of text (front matter) and sample 3 evenly-spaced windows from body — all 6 problem books now pass (alpha 0.71–0.78); k=9 pipeline run completed (695 books); coherence sweep k=2–12: best k=4 (0.0753) and k=6 (0.0744) but fixed k=9 used per prior decision; 5-seed run (seeds: 42, 7, 123, 256, 999): 7/9 stable, 0 dead, mean stability=0.382; k=10 comparison run: 6/10 stable, 0 dead, mean stability=0.383 — worse stability profile than k=9; k=9 confirmed as final solution; topic validation (`09c_validate_topics.py`) run and markdown saved; 9-topic taxonomy agreed and written to `topic_validation.json`: T1 Management Cybernetics, T2 Second-Order Cybernetics Applied to Social Systems, T3 Dynamical Systems/Homeostasis/Biological Regulation, T4 Psychological Cybernetics, T5 Non-Anglophone Engineering Cybernetics, T6 Mathematical Foundations of Cybernetics, T7 Cultural Cybernetics/Posthumanism/Digital Media, T8 Applied Cybernetics & Computers in Society, T9 Residual/Outlier Cluster; discussion: minimal-k relative to fixed vs varying seeds — k is a data capacity constraint not an ontological claim; fixed seed gives well-defined minimal k for that solution; varying seeds have no guaranteed minimal k | post-v0.4.0 |
